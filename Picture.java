...
public final class Picture implements ActionListener {
   ...
   /**
    ...
    public Picture(File file) {
        try {
            ...
            e.printStackTrace(); // Added by me (Alex Jacoby)
   ...
   /**
    * Sets title of frame we're in. Should only be called after show() to make sure
    * we're actually in a frame.
    */
    public void setTitle(String title) {
       if (frame != null) { frame.setTitle(title); }
       else {
          throw new IllegalStateException("Can't set title yet: use picture.show() first!");
       }
    }
